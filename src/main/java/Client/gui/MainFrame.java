...
public class MainFrame extends MoveJFrame {
    ...
    private void initComponents() {
        ...
        JButton _btnFormat = new JButton();
        ...
        JButton _btnDownload = new JButton();
        JButton _btnRun = new JButton();
        ...
        JButton _btnFindReplace = new JButton();
        JButton _btnRestart = new JButton();
    ...
    private void _btnFormatActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            new Thread(() -> {
                ...
                MainFrame.isFormatting = true;
                int i = 1;
                while (MainFrame.isFormatting) {
        ...
        dialogUpFile.addWindowListener(new WindowAdapter() {
            public void windowClosed(WindowEvent e) {
                if (DialogFile.isOK() && !DialogFile.latestFile.isEmpty()) {
                    DialogFile.latestFile = FileUtil.checkNullExtension(DialogFile.latestFile);
                    appendProcess("Open: " + DialogFile.latestFile);

                    String fileType = FileUtil.getFileExtension(DialogFile.latestFile);

                    if (!fileType.equals("jpg")
                            && Arrays.asList(FileUtil.supportedExtension).contains(fileType)) {
                        int typeIndex = Arrays.asList(FileUtil.supportedExtension).indexOf(fileType);
                    ...
                    if (fileType.equals("jpg")) {
                        ...
                        String code = FileUtil.read(DialogFile.latestFile);
                        if (!code.isEmpty()) {
        ...
        dialogLink.addWindowListener(new WindowAdapter() {
            public void windowClosed(WindowEvent e) {
                if (DialogLink.isOK() && !DialogLink.latestURL.isEmpty()) {
                    String fileType = FileUtil.getFileExtension(DialogLink.latestURL);
                    ...
                    if (fileType.equals("jpg")) {
                        ...
                        String code = FileUtil.readURL(DialogLink.latestURL);
                        if (!code.isEmpty()) {
                            sourceCode.setText(code);
                            sourceCode.setForeground(Color.black);
                            appendProcess("Import success");
        ...
        dialogSaveFile.addWindowListener(new WindowAdapter() {
            public void windowClosed(WindowEvent e) {
                if (DialogFile.isOK() && !DialogFile.latestFile.isEmpty()) {
                    ...
                    FileUtil.write(DialogFile.latestFile, code, false);
    ...
    private void _btnRunActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            new Thread(() -> {
                ...
                MainFrame.isCompiling = true;
                int i = 1;
                while (MainFrame.isCompiling) {
