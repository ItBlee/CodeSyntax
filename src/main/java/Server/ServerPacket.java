...
public class ServerPacket {
    ...
    public ServerPacket(String Description, String format, String output, String statusCode, String memory, String cpuTime) {
     ...
     */
    public static ServerPacket unpack(String dataPacketJSON) {
