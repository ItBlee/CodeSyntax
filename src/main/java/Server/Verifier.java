...
public class Verifier extends Thread implements Runnable {
     ...
     */
    public Verifier(SSLSocket sslClientSocket) throws IOException {
    ...
    public void run() {
        try {
            ...
            if (secretKey.length() != Encryptor.KEY_BIT_LENGTH) //secretKey phải 16 bit
                return;
