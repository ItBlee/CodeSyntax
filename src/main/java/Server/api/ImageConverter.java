...
public class ImageConverter {
    ...
    private static final String API_URL = ApiPropertyUtil.getString("image.converter.url");
    private static final String API_KEY = ApiPropertyUtil.getString("image.converter.key");
